...
запуск до сессии, что и показал `mismatch`. Реализация В1 делает конфигурацию адаптера входом
контракта v2 и требует своего плана с ревью.

**Решение человека (2026-09-21):** закрытый отказ Д10 остаётся; В1 переносится в A1R.6,
отдельного этапа до A1R.6 нет.
