...
export const BOUND_LAYER_MODULES = [
	...
	"bound/bound-child-factory.ts",
	"bound/bound-execution-port.ts",
	"bound/bound-json.ts",
	"bound/bound-launch-bridge.ts",
	"bound/bound-launch-recheck.ts",
	"bound/bound-layer-manifest.ts",
	"bound/bound-mcp-config.ts",
	"bound/bound-mcp-direct-bridge.ts",
	"bound/bound-mcp-preparation.ts",
	"bound/bound-mcp-selections.ts",
	"bound/bound-package-api.ts",
	"bound/bound-package-extensions.ts",
	"bound/bound-package-loader.ts",
	"bound/bound-pending-cancellation-registry.ts",
	"bound/bound-request.ts",
	"bound/bound-resolver.ts",
	"bound/bound-run-hooks.ts",
	"bound/bound-run-registry.ts",
	"bound/bound-runtime-service.ts",
	"bound/bound-self-check.ts",
	"bound/bound-session-bindings.ts",
	"bound/bound-stream-barrier.ts",
	"bound/bound-tool-registry-projection.ts",
	"bound/bound-tool-shadowing.ts",
	"bound/bound-transcript.ts",
